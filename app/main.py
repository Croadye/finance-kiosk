...
from .routers import budget, recurring, accounts, assets, transfers, categories, documents
...
app.include_router(categories.router, tags=["ui"])
app.include_router(documents.router, tags=["ui"])
